...
# The clinical measures based prediction
random_state = 20
n_estimators = 40
max_depth = None
min_samples_split = 5
...
# Use the total score to act as the combination
...
hds.savemat('Risk_Scores_DL_Path.mat', {'Scores_Test_DL': Scores_Test_DL})
hds.savemat('Risk_Scores_DL_Clin_Path.mat', {'Scores_Test_Clin_DL': Scores_Test_Clin_DL})
